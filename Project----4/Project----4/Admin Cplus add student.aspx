<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Cplus_add_student.aspx.cs" Inherits="Project____4.Admin_Cplus_add_student" %>
                        ...
                        <div class="container mt-5">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div class="btn-group">
                                    ...
                                    <asp:LinkButton runat="server" CssClass="btn btn-primary dropdown-toggle dropdown-toggle-split" Text="<span class='sr-only'>Toggle Dropdown</span>" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" />
                                    ...
                                    <!-- Download Button -->
                                    <asp:Button ID="btnDownload" runat="server" CssClass="btn btn-primary" style="margin-left: 10px; border-radius: 6px;" OnClick="btnDownload_Click" Text='Download' />
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table custom-table" OnRowCommand="GridView1_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Name">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("Id", "result for each student.aspx?Id={0}") %>' Text='<%# Eval("Name") %>'>
                                                </asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
