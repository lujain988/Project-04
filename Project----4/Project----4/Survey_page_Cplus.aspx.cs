...
namespace Survey_and_Student_courses_pages
{
    public partial class Survey_page_Cplus : System.Web.UI.Page
    {
        ...
        {
            feedbackPath = Server.MapPath("~/feedbackCplus.txt");
            questionsPath = Server.MapPath("~/questionsPlus.txt");
            feedbackCountPath = Server.MapPath("~/feedbackCount.txt");
            ...
            if (File.Exists(questionsPath))
            {
                ...
                if (allAnswered)
                {
                    if (Session["UserID"] != null)
                    {
                        ...
                        Session["SurveySubmitted_Cplus"] = true;
                        ShowThankYou();
                    }
                    else
                    {
