...
namespace Survey_and_Student_courses_pages
{
    public partial class Survey_page_nodejs : System.Web.UI.Page
    {
        ...
        {
            feedbackPath = Server.MapPath("~/feedbackNodejs.txt");
            questionsPath = Server.MapPath("~/questionsnodeJS.txt");
            feedbackCountPath = Server.MapPath("~/feedbackCountNodejs.txt");
