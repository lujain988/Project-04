...
<asp:Button ID="btnDeleteAll" runat="server" Text="Delete All" CssClass="btn btn-danger" OnClick="btnDeleteAll_Click" />

                                  <!-- Download Button -->
<asp:Button ID="btnDownload" runat="server" CssClass="btn btn-primary" OnClick="btnDownload_Click"
    Text='Download' />
