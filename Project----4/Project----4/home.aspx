<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="Project____4.home" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12">
                            <div class="text-center mb-5 pb-2">
                                <h1 class="text-white">Welcome to CodeSphere</h1>

                            <p class="text-white">Join Us Now!, And Unlock Your Coding Potential.</p>

                                <h3 class="text-white">Our Latest Students:</h3>
                            </div>

                            <div class="owl-carousel owl-theme">
                                <asp:Panel runat="server" CssClass="owl-carousel-info-wrap item">
                                ...
                                <asp:Panel runat="server" CssClass="owl-carousel-info-wrap item">
                                   <img src="images/profile/nour.jpg"
                                    class="owl-carousel-image img-fluid" alt="">
                                ...
                                <div class="owl-carousel-info">
                                    ...
                                    <span class="badge">C++</span>
                                        ...
                                        <asp:Panel runat="server" CssClass="owl-carousel-info-wrap item">
                                   <img src="images/profile/portrait-handsome-smiling.jpg"
                                    class="owl-carousel-image img-fluid" alt="">
